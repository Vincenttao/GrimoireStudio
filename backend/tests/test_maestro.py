...
from backend.models import GrimoireSnapshot, GrimoireStateJSON, MaestroDecision, TheSpark
...
async def test_maestro_cut_interruption(monkeypatch):
    ...
    spark = TheSpark(spark_id="test_run_1", chapter_id="chap_1", user_prompt="start fighting")
